package com.lambdaschool.devdesk.queue.config;
...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.lambdaschool.devdesk.queue"))
    ...
    {
        return new ApiInfoBuilder().title("Dev Desk Queue")
                .description("A helpdesk solution")
                .contact(new Contact("Devin Bidwell",
                        "https://biddydev.com",
                        "dbidwell94@gmail.com"))
                .license("MIT")
                .version("1.0.0")
                .build();
    }
